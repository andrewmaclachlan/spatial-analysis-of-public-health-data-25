...
Please download the relevant GTFS.zip file for the UK for the public transport timetable data from [Mobility Database](https://mobilitydatabase.org).
...
r5r_core <- setup_r5(data_path = "prac5_data/.")
```
